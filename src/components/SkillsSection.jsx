...
const skills = [
  ...
  { name: "JavaScript/JQuery", level: 85, category: "frontend" },
  { name: "React", level: 65, category: "frontend" },
  { name: "TypeScript", level: 55, category: "frontend" },
  { name: "Electron.js", level: 10, category: "frontend" },
  { name: "Remix.js", level: 40, category: "frontend" },
